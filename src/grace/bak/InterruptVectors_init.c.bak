...
int u;
int counter = 0;
int receive_buffer[9]={0, 0, 0, 0, 0, 0, 0, 0 ,0 };
int Rstorage_buffer[9]={0, 0, 0, 0, 0, 0, 0, 0 ,0 };

int foo(int x){    /* Function definition */
	return Rstorage_buffer[x];
}
...
__interrupt void USCI0RX_ISR_HOOK(void)
{
	...
	receive_buffer[counter] = UCA0RXBUF;
	counter++;
	if(UCA0RXBUF == 0x65){
		counter = 0;
		for(u = 0; u<9; u ++){
			Rstorage_buffer[u] = receive_buffer[u];
		}
	}
